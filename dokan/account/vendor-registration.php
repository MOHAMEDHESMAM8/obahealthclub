...
<form id="dokan-vendor-register" method="post" class="register dokan-vendor-register">
    ...
    <p class="form-row form-group form-row-wide">
        <label for="company-name"><?php esc_html_e( 'Store Name', 'dokan-lite' ); ?> <span class="required">*</span></label>
    ...
    <p class="form-row form-group form-row-wide" style="display:none;">
...
<script>
    ( function ( $ ) {
        $( document ).ready( function () {
            // Auto-generate Shop URL from Store Name
            $( '#company-name' ).on( 'input', function () {
                var storeName = $( this ).val();
                // Convert to URL-friendly slug: lowercase, replace spaces with hyphens, remove special chars
                var slug = storeName.toLowerCase()
